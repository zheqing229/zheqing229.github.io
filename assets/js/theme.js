...
function addMermaidZoom(records, observer) {
...
function setDiff2htmlTheme(theme) {
...
function setEchartsTheme(theme) {
...
function setVegaLiteTheme(theme) {
...
function setCookieConsentTheme(theme) {
...
function initThemeToggle() {
  ...
  if (!modeToggle || modeToggle.dataset.themeBound === "true") return;
...
function getCalendarUrl(calendarId, timezone = "UTC") {
